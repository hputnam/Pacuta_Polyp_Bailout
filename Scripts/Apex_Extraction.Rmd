...
Read in xml info
```{r}
apex.xmlfile <- xmlParse("http://10.10.204.74/cgi-bin/datalog.xml?sdate=250802&days=2") #read in the date (e.g. 180620) plus # days (e.g. days=4) of Apex data
...
```{r} 
start_time <- as.POSIXct("2025-07-31 11:18:00")
end_time   <- as.POSIXct("2025-08-01 07:40:00")
